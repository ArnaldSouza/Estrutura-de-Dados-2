...
void apresentaArquivo(int *vetor, int numero, FILE *saida){
  ...
  // insertionSort
    ...
    diferenca = (double)(fim - comeco) / (CLOCKS_PER_SEC / 1000);
    fprintf(saida, ", %d comp, %.5d ms\n", comparacao, diferenca);
